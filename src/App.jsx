...
function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const prompt = `
        You are an official government misinformation detection system. Analyze the following content with the highest standards of accuracy and provide a professional assessment.
        ...
        {{
          ...
          "recommendation": "Official recommendation for citizens regarding this content."
        }}
        `;
        ...
        <Toolbar sx={{ py: 1 }}>
          ...
          <Box sx={{ flexGrow: 1 }}>
            <Typography variant="h6" component="div" sx={{ fontWeight: 700 }}>
              Government Information Verification System
            </Typography>
            <Typography variant="caption" sx={{ opacity: 0.9 }}>
              Official Misinformation Detection & Analysis Platform
            </Typography>
          </Box>
          <Chip 
            icon={<ShieldIcon />} 
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 6 }}>
        ...
        >
          <Typography variant="body2" sx={{ fontWeight: 500 }}>
            <strong>OFFICIAL NOTICE:</strong> This system uses advanced AI technology to detect misinformation and verify content authenticity. 
            All analyses are conducted according to government standards and protocols.
          </Typography>
        </Alert>
          ...
          <Grid item xs={12} lg={8}>
            <Paper elevation={2} sx={{ p: 4, borderRadius: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body1" color="text.secondary">
                    Submit content below for official government verification and misinformation detection
                  </Typography>
                </Box>
              </Box>
              ...
              <TextField
                ...
                rows={8}
                variant="outlined"
                label="Content for Official Verification"
              ...
              >
                {loading ? 'ANALYZING CONTENT...' : 'INITIATE OFFICIAL VERIFICATION'}
              </Button>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} lg={4}>
            <Card sx={{ mb: 3 }}>
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary" paragraph>
                  This official government system employs state-of-the-art artificial intelligence to:
                </Typography>
                <List dense>
                  <ListItem>
            ...
            <Alert severity="warning" sx={{ borderRadius: 2 }}>
              <Typography variant="body2">
                <strong>IMPORTANT:</strong> This system is for informational purposes. 
                Always cross-reference with multiple official sources.
              </Typography>
            </Alert>
          </Grid>
        </Grid>
            ...
            <CardContent sx={{ p: 4 }}>
              ...
              <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Alert severity="info" sx={{ borderRadius: 2 }}>
                    <Typography variant="body2">
                      <strong>GOVERNMENT RECOMMENDATION:</strong> {result.recommendation}
                    </Typography>
                  </Alert>
                </Grid>
              </Grid>
              ...
              <Box sx={{ mt: 4, p: 3, bgcolor: 'grey.50', borderRadius: 2 }}>
                <Typography variant="caption" color="text.secondary" sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  This analysis was generated by the Official Government Information Verification System. 
                  Report ID: GIV-{Date.now().toString().slice(-8)} | Generated: {new Date().toLocaleString()}
                </Typography>
              </Box>
            </CardContent>
          </Card>
